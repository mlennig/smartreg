...
//TODO: Change the toolbar. (Future Cosmetic Change)
...
public class RoomDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Floating action button (Will be a configuration/settings icon)
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentStartRoomSettingsActivity = new Intent(getApplicationContext(), RoomSettingsActivity.class);
                startActivity(intentStartRoomSettingsActivity);
            }
        });
